...
function zoomImg (url) {
    ...
    imgMinus.setAttribute('src', process.env.BASE_URL + 'img/zoom_minus.svg')
    ...
    imgAdd.setAttribute('src', process.env.BASE_URL + 'img/zoom_add.svg')
    ...
    imgRotate.setAttribute('src', process.env.BASE_URL + 'img/zoom_rotate.svg')
    ...
    imgClose.setAttribute('src', process.env.BASE_URL + 'img/zoom_close.svg')
