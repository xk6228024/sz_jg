...
<template>
    <div class="header-top">
        <div class="main-title fl">
            ...
            <img class="icon-img" src='../assets/images/login-logo-jg.png' alt="">
            <h4 class="title-h" v-text="title.length > 50 ? title.slice(0, 50) + '...' : title"></h4>
        </div>
        <div class="user fr">
            ...
            <!-- <div class="avatar">
                ...
                <img v-else src="../assets/images/icon-user-my.jpg" alt="">
            </div> -->
...
export default {
    ...
    created () {
        ...
        // try {
        //     this.name = JSON.parse(getCookie('user')).name
        //     this.avatar = JSON.parse(getCookie('user')).avatar
        // } catch (e) {}
        // this.getWranList()
        // setInterval(() => {
        //     this.getWranList()
