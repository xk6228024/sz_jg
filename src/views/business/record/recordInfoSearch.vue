                ...
                <div class="table_top_l clearfix" :class="{'arrow-active': arrowActive}">
                    ...
                    <div class="table_top_ls" v-if="arrowActive">
                        ...
                        <el-select class="tool_ipt" v-model="searchStatus" placeholder="请选择">
                            ...
                            <el-option label="已认证待备案审核" value="3"></el-option>
                            <el-option label="备案审核不通过" value="4"></el-option>
                            <el-option label="已备案" value="5"></el-option>
                        </el-select>
                    </div>
...
export default {
    ...
    data () {
        return {
            breadArr: [
                { title: '档案管理', path: '' }, { title: '维修企业备案信息查询', path: '' }
            ],
            total: 0,
            pageNum: 1,
            pageSize: 10,
