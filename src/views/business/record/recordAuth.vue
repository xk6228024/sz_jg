            ...
            dataList: [
                {
                    ...
                    enterpriseDetailedAddress: '小店区来宾路1-2号',
                    createTime: '2020-01-09 18:00:00'
                },
                {
                    num: '02',
                    enterpriseName: '罗马汽车服务有限公司',
                    enterpriseAreaStr: '小店区',
                    ...
                    enterpriseOwner: '海蒂',
                    enterpriseOwnerPhone: '13265477781',
                    enterpriseDetailedAddress: '小店区西湖路10-1号',
                    createTime: '2020-01-09 18:00:00'
                },
                {
                    num: '03',
                    enterpriseName: '紫罗兰汽车服务有限公司',
                    enterpriseAreaStr: '小店区',
                    ...
                    enterpriseOwner: '拉玛',
                    enterpriseOwnerPhone: '13265477781',
                    enterpriseDetailedAddress: '小店区民主大道11-11号',
                    createTime: '2020-01-09 18:00:00'
                },
                {
                    num: '04',
                    enterpriseName: '太原市小店区阿柱汽车冷气维修部',
                    enterpriseAreaStr: '小店区',
                    enterpriseBusinessCategory: '3',
                    enterpriseRecordTypeStr: '初次备案',
                    enterpriseSource: '3',
                ...
                {
                    num: '05',
                    enterpriseName: '太原市万柏林区汉枫汽车服务有限公司',
    ...
    methods: {
        queryData (clear) {
            ...
            if (this.$route.query.regionName) {
                this.dataList = this.$filterRegion(this.dataList, 'enterpriseAreaStr', this.$route.query.regionName)
            }
            // if (clear) {
            //     this.pageNum = 1
            // }
