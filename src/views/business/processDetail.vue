                ...
                <el-tabs v-model="activeName" type="card" @tab-click="changeTabs">
                    ...
                    <el-tab-pane label="企业自评" name="tab2" class="tab2">
                        <div class="tableInfo clearfix">
                            <h5 style="text-align:center;">机动车维修企业信用等级评分表</h5>
                            <span class="span1">企业名称:得德发汽车服务有限公司</span>
                            <span class="span2">检查日期:2020-05-03</span>
                            <span class="span3">检查人员:薛西</span>
    ...
    data () {
        return {
            ...
            materialsList2: [
                {
                    num: '01',
                    enterpriseEvaluateSelfMaterialYear: '2019',
                    enterpriseName: '太原东京玫瑰汽车服务有限公司',
                    indexTermSuperviseName: '环境卫生',
                    enterpriseEvaluateSelfMaterialExplain: '卫生状况说明',
                    enterpriseEvaluateSelfMaterialDesc: '卫生状况相关图片',
                    enterpriseEvaluateSelfMaterialUnit: '德顺检测站',
                    createTime: '2019-11-25 15:20:00',
                    enterpriseEvaluateSelfMaterialStatus: '已审核',
                    enterpriseEvaluateSelfFileUrl: 'http://www.baidu.com'
                },
                {
                    num: '02',
                    enterpriseEvaluateSelfMaterialYear: '2020',
                    enterpriseName: '博纳汽车服务有限公司',
                    indexTermSuperviseName: '仪表设备',
                    enterpriseEvaluateSelfMaterialExplain: '专业设备图片',
                    enterpriseEvaluateSelfMaterialDesc: '专业设备图片',
                    enterpriseEvaluateSelfMaterialUnit: '德顺检测站',
                    createTime: '2020-03-25 13:11:00',
                    enterpriseEvaluateSelfMaterialStatus: '已审核',
                    enterpriseEvaluateSelfFileUrl: 'http://www.baidu.com'
                },
                {
                    num: '03',
                    enterpriseEvaluateSelfMaterialYear: '2019',
                    enterpriseName: '壹佰汽车服务有限公司',
                    indexTermSuperviseName: '环境卫生',
                    enterpriseEvaluateSelfMaterialExplain: '卫生状况说明',
                    enterpriseEvaluateSelfMaterialDesc: '卫生状况相关图片',
                    enterpriseEvaluateSelfMaterialUnit: '德顺检测站',
                    createTime: '2019-11-19 09:55:00',
                    enterpriseEvaluateSelfMaterialStatus: '未审核',
                    enterpriseEvaluateSelfFileUrl: 'http://www.baidu.com'
                }
            ],
            ...
            applyList: [
                {
                    num: '01',
                    // enterpriseEvaluateSuperviseName: '安全生产',
                    indexTermTypeId: '安全生产',
                    enterpriseEvaluateSuperviseName: '安全生产管理',
                    enterpriseEvaluateSuperviseDesc: '未建立并落实安全生产责任制、未配备专（兼）职安全生产管理人员、企业主要负责人和安全管理人员未经安全培训合格、未制定岗位安全操作规程并明示在相应岗位、未定期开展安全隐患排查、未制定生产安全事故应急预案、未按规定组织应急演练的，每一项扣10分；发生安全生产责任事故造成人员住院的，扣20分/宗；造成人员死亡的，不得分。',
                    enterpriseEvaluateSuperviseAppealDesc: '符合政府要求',
                    enterpriseEvaluateSuperviseEnterpriseScore: 3,
                    enterpriseEvaluateSuperviseInitScore: 1,
                    enterpriseEvaluateSuperviseAppealScore: 3,
                    enterpriseEvaluateSuperviseScore: 2,
                    createTime: '2020-01-01 12:00:00',
                    enterpriseEvaluateSuperviseFinalScore: 1
                }
            ], // 异议申诉列表
            ...
            selfList: [
                {
                    ...
                    enterpriseEvaluateSuperviseDesc: '未建立并落实安全生产责任制、未配备专（兼）职安全生产管理人员、企业主要负责人和安全管理人员未经安全培训合格、未制定岗位安全操作规程并明示在相应岗位、未定期开展安全隐患排查、未制定生产安全事故应急预案、未按规定组织应急演练的，每一项扣10分；发生安全生产责任事故造成人员住院的，扣20分/宗；造成人员死亡的，不得分。',
                    enterpriseEvaluateSuperviseEnterpriseScore: 3,
                    enterpriseEvaluateSuperviseScore: 3,
                    enterpriseEvaluateSuperviseFinalScore: 3
                },
                {
                    num: '02',
                    indexTermTypeId: '服务质量',
                    enterpriseEvaluateSuperviseName: '行业稳定',
                    enterpriseEvaluateSuperviseDesc: '因企业管理原因，发生违反《信访条例》规定，企业员工集体上访等但情节不严重且经批评教育后及时改正的，扣25分/次；经批评教育后未及时改正的，扣50分/次。企业转嫁经营矛盾，将问题推向主管部门的，扣50分/次。',
                    enterpriseEvaluateSuperviseEnterpriseScore: 11,
                    enterpriseEvaluateSuperviseFinalScore: 3,
                    enterpriseEvaluateSuperviseScore: 3
                },
                {
                    num: '03',
                    indexTermTypeId: '遵纪守法',
                    enterpriseEvaluateSuperviseName: '合同履约',
                    enterpriseEvaluateSuperviseDesc: '企业经营发生合同纠纷，在司法终审判定中败诉。每发生一次记负面分20分，负面分达到100分则该项评价为不诚信。',
                    enterpriseEvaluateSuperviseEnterpriseScore: 2,
                    enterpriseEvaluateSuperviseFinalScore: 2,
                    enterpriseEvaluateSuperviseScore: 1
                }
            ], // 自评列表
            materialsList: [], // 材料列表
