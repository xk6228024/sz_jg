            ...
            <div class='wrap'>
                ...
                <div class="table_box">
                    ...
                    <el-table-column
                        ...
                        >
                        <template slot-scope="scope">
                            <span>{{$randomTime()|formatTimeS}}</span>
                        </template>
                    </el-table-column>
                    <el-table-column
                        prop="name"
...
export default {
    ...
    methods: {
        queryData () {
            ...
            // this.dataList = this.$setNum(list, 1, 99)
