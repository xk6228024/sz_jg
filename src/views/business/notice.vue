    ...
    data () {
        return {
            ...
            dataList: [
                ...
                {
                    noticeTitle: '电子健康档案上传',
                    noticePublishTime: '2020-04-05 10:10:00',
                    noticeUser: 'admin',
                    noticeStatus: 1,
                    noticeAuditName: '管理员',
                    noticeStatusBak: ''
                ...
                {
                    noticeTitle: '维修企业勘验流程相关说明',
                    noticePublishTime: '2020-05-14 12:30:00',
                    noticeUser: 'admin',
                    noticeStatus: 1,
                    noticeAuditName: '管理员',
                    noticeStatusBak: ''
                ...
                {
                    noticeTitle: '太原运输车辆检测流程调整',
                    noticePublishTime: '2020-01-14 15:12:04',
                    noticeUser: 'admin',
                    noticeStatus: 0,
                    noticeAuditName: '管理员',
                    noticeStatusBak: '5月1号试行'
                }
            ]
        }
    },
