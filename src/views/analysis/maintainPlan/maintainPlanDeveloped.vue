                ...
                <div class="table_box">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            {{scope.row.time|filterTime('yyyy-mm-dd')}}
                        </template>
                    </el-table-column>
                  </el-table>
                </div>
...
export default {
    ...
    data () {
        return {
            ...
            breadArr: [
                { title: '查询统计', path: '' }, { title: '维护计划查询统计', path: '' }
            ],
            searchName: '',
            total: 4,
            pageNum: 1,
