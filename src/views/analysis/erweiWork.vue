    ...
    <div class="companyArch">
                    ...
                    <div class="table_top_l clearfix" :class="{'arrow-active': ArrowActive}">
                        ...
                        <div class="table_top_ls">
                            ...
                            <el-select  class="tool_ipt" v-model="enterpriseIsAudit" clearable placeholder="请选择">
                                <el-option
                                v-for="item in [{value:1,label:'维修工'},{value:2,label:'检测工'}]"
                                :key="item.value"
                                :label="item.label"
                                :value="item.value">
                                </el-option>
                        ...
                        <div class="table_top_ls" >
                            ...
                            <el-select  class="tool_ipt" v-model="enterpriseIsAudit" clearable placeholder="请选择">
                                <el-option
                                v-for="item in [{value:1,label:'一级'},{value:2,label:'二级'}]"
                                :key="item.value"
                                :label="item.label"
                                :value="item.value">
                                </el-option>
                        ...
                        <div class="table_top_lr fr">
                            ...
                            <el-button class="query_btn slects_btn" @click="findenterprisebytype(1)" :disabled="!$checkAuth('manage:enterprise:findw')">查询</el-button>
                ...
                <div class="table_box">
                    ...
                    <el-table-column
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button type="text" size="small" @click="toDetail(scope.row.enterpriseId)">编辑</el-button>
                            <el-button type="text" size="small" @click="openPortAlert(scope.row)">删除</el-button>
                        </template>
                    </el-table-column>
                    </el-table>
                    <div class="page_box">
        ...
        <modal :title="'数据接口账号密码设置'" :alert="alert" @alertCancel="alertCancel" :width="800" :height="320" class="port-alert clearfix">
            <div class="province fl">
                ...
                <div class="btn">
                    <el-button class="apply" @click="provinceApply" type="primary" v-if="!provincePsw && !provinceOrder" :disabled="!$checkAuth('manage:enterprise:findEnterpriseProvinceUserApply')">申请</el-button>
        ...
        <modal :title="'数据接口账号密码设置'" :alert="alertBox1" @alertCancel="alertCancelBox1" :width="450" :height="320" class="port-alert clearfix">
            <div class="province1">
                <h5>省级平台接口</h5>
                <div class="info-item">
                    <div class="left">
        ...
        <bread-foot :breadArr="breadArr" icons="icon-archives-normal">
            <!-- <el-button type="primary" @click="addCompArch" v-if="chooseId==='1'" :disabled="!$checkAuth('manage:enterprise:addentrecord')">维修企业建档</el-button>
            <el-button type="primary" @click="addCompArch" v-if="chooseId==='2'">检测企业建档</el-button> -->
        </bread-foot>
    </div>
</template>
...
export default {
    ...
    data () {
        return {
            breadArr: [
                { title: '数据统计', path: '' }, { title: '从业人员查询', path: '' }
            ],
            tableloading: false,
            ArrowActive: true, // 展开
    ...
    methods: {
        ...
        addCompArch () {
            ...
            this.$router.push('/compArchDetailw')
        },
        // 查看详情
        toDetail (id) {
            if (!this.$checkAuth('manage:enterprise:vieww')) {
            ...
            this.$router.push('/compArchDetailw?id=' + id)
        },
        // 省平台申请账号
        provinceApply () {
        ...
        accountEntry (type) {
            ...
            if (type === 'province') {
                if (!this.$checkAuth('manage:enterprise:updatePassCity')) {
                    this.$alert('没有录入权限！', '提示')
                    return
                }
        ...
        openPortAlert (item) {
            ...
            if (item.enterpriseSource === 4 || item.enterpriseSource === 5) {
                this.alertBox1 = true
            } else {
                this.alert = true
            }
        ...
        alertCancelBox1 () {
            ...
            this.enterpriseCityPass = ''
            this.enterpriseCityUser = ''
            this.alertBox1 = false
        },
        // 获取企业档案列表
        findenterprisebytype (clear) {
            if (!this.$checkAuth('manage:enterprise:findw')) {
                this.$alert('没有查询权限！', '提示')
                return
            }
            if (clear) {
