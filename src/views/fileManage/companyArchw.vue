        ...
        <div class="content">
            ...
            <div class="wrap1">
                ...
                <div class="table_box">
                    ...
                    <el-table-column
                        prop="a4"
                        key="enterpriseBusinessCategory"
                        :show-overflow-tooltip='true'
                        label="企业等级">
...
export default {
    ...
    methods: {
        ...
        findenterprisebytype (clear) {
            this.tableData3 = this.$getEntList()
            if (this.$route.query.regionName) {
                this.tableData3 = this.$filterRegion(this.tableData3, 'enterpriseAreaStr', this.$route.query.regionName)
            }
