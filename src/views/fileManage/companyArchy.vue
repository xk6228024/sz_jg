...
<template>
    <div class="companyArch">
                ...
                <div class="clearfix table_top table_tap_pad">
                    <div class="table_top_l clearfix" :class="{'arrow-active': ArrowActive}">
                        ...
                        <div class="table_top_lr fr">
                            ...
                            <el-button class="query_btn slects_btn" @click="findenterprisebytype(1)" :disabled="!$checkAuth('manage:enterprise:findy')">查询</el-button>
        ...
        <bread-foot :breadArr="breadArr" icons="icon-archives-normal">
            <el-button type="primary" @click="addCompArch">运输企业建档</el-button>
        </bread-foot>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        addCompArch () {
            ...
            this.$router.push('/ysEnterpriseDetail')
        },
        // 查看详情
        toDetail (id) {
            if (!this.$checkAuth('manage:enterprise:viewy')) {
            ...
            // path = path + id
            // this.$router.push(path)
            this.$router.push('/compArchDetaily?id=' + id)
        },
        // 省平台申请账号
        provinceApply () {
        ...
        accountEntry (type) {
            ...
            if (type === 'province') {
                if (!this.$checkAuth('manage:enterprise:updatePassProvince')) {
        ...
        findenterprisebytype (clear) {
            if (!this.$checkAuth('manage:enterprise:findy')) {
                this.$alert('没有查询权限！', '提示')
                return
            }
            if (clear) {
