                        ...
                        <div class="right">
                            <div class="info-item clearfix">
                                ...
                                <div class="msg fl">
                                    ...
                                    <img src="@/assets/images/xianshi.png" style="float:left;margin:18px 10px;cursor: pointer;" @click="$zoomImg(societyData.associationLogo)" v-if="societyData.associationLogo">
                                </div>
                            </div>
                            <div class="info-item clearfix">
                                <div class="name fl">
...
export default {
    ...
    data () {
        return {
            breadArr: [
                { title: '业务操作', path: '' }, { title: '协会管理', path: '' }
            ],
    ...
    methods: {
        ...
        saveData () {
            ...
            if (!/^[A-Za-z\u4e00-\u9fa5]+$/.test(this.societyData.associationLink)) {
                this.$alert('联系人只能输入中文和字母！', '提示')
                return
            }
            ...
            if (!/^1[3456789]\d{9}$/.test(this.societyData.associationLinkMobile)) {
                this.$alert('请输入正确的联系人电话，应为11位手机号码！', '提示')
                return
            }
            ...
            this.$post('external/association/detail', {
                ...
                .then(res => {
                    if (res.status === 200) {
                        ...
                        setTimeout(() => {
                            this.center.lng = this.societyData.associationMapX - 0
                            this.center.lat = this.societyData.associationMapY - 0
                        }, 500)
                    } else {
                        console.log(res.message)
                    }
        ...
        uploadSuccess (res) {
            if (res.status === 200) {
                ...
                this.$set(this.societyData, 'associationLogo', res.data)
            }
            // var _this = this
            // var img = new Image()
            // img.src = res.data
