                ...
                h.forEach(function(e, t) {
                    if (e) {
                        ...
                        d.append(c),
                            ...
                            f.push(c),
                            0 === t
                                ? ((r._active = !0), r.addClass('w-e-active'))
                                : c.hide(),
    ...
    ;(q.bold = l),
        ...
        (U.prototype = {
            ...
            _dragHandle: function() {
                var e = this.editor
                o(document).on('dragleave drop dragenter dragover', function(
                    e
                ) {
                    e.preventDefault()
                }),
            ...
            saveRange: function(e) {
                ...
                if (0 !== t.rangeCount) {
                    ...
                    if (
                        ...
                        this.editor.$textElem.isContain(i) &&
                ...
                if (w || o || c) {
                    ...
                    if (
                        (r(e, function(e) {
                            ...
                            if (t && n)
                                return !1 ===
                                    /\.(jpg|jpeg|png|bmp|gif|webp)$/i.test(t)
                                    ? void E.push('【' + t + '】不是图片')
                                    : a < n
                                    ? void E.push(
                                          '【' + t + '】大于 ' + s + 'M'
                            ...
                            (C.onreadystatechange = function() {
                                ...
                                if (4 === C.readyState) {
                                    ...
                                    if (
                                        ...
                                        e.data = [e.data]
                                        // console.log(e)
                                    if (f.customInsert || 200 == e.status) {
                                        if (
                                            f.customInsert &&
                                            'function' == typeof f.customInsert
                                        )
                                            f.customInsert(
                                                t.insertLinkImg.bind(t),
                                                e,
                                                n
                                            )
                                        else {
