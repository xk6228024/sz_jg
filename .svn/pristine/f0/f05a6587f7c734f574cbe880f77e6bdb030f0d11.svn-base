...
export default {
    ...
    data () {
        return {
            breadArr: [
                { title: '业务操作', path: '' }, { title: '企业诚信参评', path: '' }, { title: '诚信指标设置', path: '' }
            ],
            ...
            dataList2: [
                {
                    num: '01',
                    indexTermSuperviseName: '检测是否存在安全隐患',
                    indexTermSuperviseDesc: '满分十分，存在一个安全隐患抠5分',
                    indexTermSuperviseScore: '10'
                }
            ], // 诚信指标列表
            dataList: [
                {
                ...
                },
                {
                    ...
                    indexTermSuperviseName: '服务态度',
                    indexTermSuperviseDesc: '服务态度优秀得10分,一般得8分,较差得5分,受到相关投诉一次减1分',
                    indexTermSuperviseScore: 10,
                    indexTermName: '服务质量'
                },
                {
