<template>
    <div class="addModel">
        <div class="contents">
            <div class="clearfix table_top table_tap_pad">
                <div class="table_top_l clearfix" :class="{'arrow-active': arrowActive}">
                    <div class="table_top_ls" v-show="chooseId==0">
                    ...
                    <div class="table_top_ls" v-if="arrowActive && chooseId==0">
                         <label for="">状态：</label>
                    ...
                    <div class="table_top_ls" v-show="chooseId==1">
                    ...
                    <div class="table_top_lr fr">
                        <el-button type="text" v-if="arrowActive && chooseId==0" @click="arrowActive = !arrowActive">收起 <i class="el-icon-arrow-up"></i></el-button>
                        <el-button type="text" v-if="!arrowActive && chooseId==0" @click="arrowActive = !arrowActive">展开 <i class="el-icon-arrow-down"></i></el-button>
                        <el-button class="query_btn slects_btn"  @click="queryData(1)" :disabled="!$checkAuth('external:news:findnews')">查询</el-button>
        ...
        <bread-foot :breadArr="breadArr" icons="icon-business-normal">
            <el-button v-if="chooseId==0" class="add_btn" type="primary" icon="el-icon-plus" @click="$router.push('/newsDetail')" :disabled="!$checkAuth('external:news:add')">
                添加新闻
            </el-button>
            <el-button v-else class="add_btn" type="primary" icon="el-icon-plus" @click="addNewsType">
                添加新闻类型
            </el-button>
        </bread-foot>
        <Modal
...
export default {
    ...
    data () {
        return {
            breadArr: [
                { title: '业务操作', path: '' }, { title: '新闻管理', path: '' }
            ],
            arrowActive: false,
            chooseIcon: 1,
            ...
            dataList: [
                {
                    ...
                    isRight: '否',
                    status: '停用',
                    updateTime: '2020-01-22 12:35:00',
                    title: '汽车报废标准须知',
                    author: '小飞燕',
                    browse: '1000',
                    source: '协会网站',
                ...
                },
                {
                    ...
                    isRight: '否',
                    status: '正常',
                    updateTime: '2020-05-11 06:00:00',
                    title: '汽车报废年限相关说明',
                    author: '孙少平',
                    browse: '8800',
                    source: '协会网站',
                ...
                },
                {
                    ...
                    isRight: '否',
                    status: '正常',
                    updateTime: '2020-04-03 02:55:00',
                    title: '汽车固废物回收途径推荐',
                    author: '徐晓霞',
                    browse: '8800',
                    source: '协会网站',
